...
<tr><td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i1"; ?>.jpg" width="180" height="180" class="img-responsive" ></center>
<br/></td></tr><br/>
<tr><td><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i2"; ?>.jpg" width="180" height="180" class="img-responsive" ></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i3"; ?>.jpg" width="180" height="170"></center>
	</td>
<br/></tr>
<tr>
	<td></br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i4"; ?>.jpg" width="190" height="180"></center>
	</td>
<br/></tr>
<tr>
	<td></br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i6"; ?>.jpg" width="170" height="160"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
	<label><input type="radio" name="pilihan" value="<?php echo "$p10"; ?>"  /><?php echo "$p10"; ?></label>&nbsp;&nbsp;
	<label><input type="radio" name="pilihan" value="<?php echo "$p8"; ?>"  /><?php echo "$p8"; ?></label><br/>
	<label><input type="radio" name="pilihan" value="<?php echo "$p6"; ?>"  /><?php echo "$p6"; ?></label>&nbsp;&nbsp;
	</td>
</tr>
<?php
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i7"; ?>.jpg" width="140" height="140"></center>
	</td>
<br/></tr>
<tr>
	<td></br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i8"; ?>.jpg" width="160" height="160"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i9"; ?>.jpg" width="170" height="150"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
