  ...
  <div class="navbar-header">
                ...
                <div class="collapse navbar-collapse" id="mynavbar-content">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu2"><a href="../../about.php" style="color:orange"><b>Tentang</b></a></b></li>
...
<div id="header1"><img src="../../img/logo.png" class="img-responsive" style="float:center; margin-left:80px;" width="150px"div>
</br></br></br>
<?php
session_start();
