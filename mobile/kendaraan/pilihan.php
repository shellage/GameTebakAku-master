...
<tr><td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i1"; ?>.jpg" width="170" height="150" class="img-responsive" ></center>
<br/></td></tr><br/>
<tr><td><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i3"; ?>.jpg" width="180" height="160"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i4"; ?>.jpg" width="190" height="150"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i5"; ?>.jpg" width="170" height="155"></center>
	</td>
</tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i6"; ?>.jpg" width="210" height="190"></center>
	</td>
</tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i7"; ?>.jpg" width="170" height="150"></center>
	</td>
</tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i8"; ?>.jpg" width="180" height="150"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i9"; ?>.jpg" width="190" height="160"></center>
	</td>
<br/></tr><br/>
<tr>
	<td></br/><br/>
...
<tr>
	<td>
		<center><img src="../../gambar/<?php echo "$f"; ?>/<?php echo "$i10"; ?>.gif" width="190" height="170"></center>
	</td>
<br/></tr><br/>
<tr>
	<td>
